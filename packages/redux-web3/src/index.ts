...
export { EventFilterConfig, EventFilter } from './sources/event/event.selectors';
...
export { getContract, callContract, getAccount, getEvents, getFeed, getIPFSHash } from './sources/propMappers';
