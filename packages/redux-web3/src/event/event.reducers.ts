...
const EventInsertSubscriptionReducer: Reducer<EventState, EventInsertSubscriptionAction> = (
  state: EventState,
...
const EventRemoveReducer: Reducer<EventState, EventRemoveAction> = (
  state: EventState,
...
const EventBroadcastedReducer: Reducer<EventState, EventBroadcastedAction> = (
  state: EventState,
  ...
  return {
    ...state,
    event_feed: [...state.event_feed],
  };
};

export const event: Reducer<EventState, EventActions> = (
  state: EventState = { event_feed: [], subscriptions: {} },
  action: EventActions,
): EventState => {
  switch (action.type) {
