...
describe('Contracts Actions', (): void => {
  ...
  test('ContractSend', (): void => {
    const ret = ContractSend(contractName, contractAddress, contractMethod, transactionArgs, contractInstance, 1, '2', [
      3,
    ]);
  ...
  test('ContractCall', (): void => {
    const ret = ContractCall(contractName, contractAddress, contractMethod, transactionArgs, contractInstance, 1, '2', [
      3,
    ]);
  ...
  test('ContractVarErrorReceived', (): void => {
    const ret = ContractVarErrorReceived(
      contractName,
      contractAddress,
      contractMethod,
      contractMethod,
