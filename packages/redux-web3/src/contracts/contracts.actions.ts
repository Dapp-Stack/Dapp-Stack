...
export function ContractLoaded(
  contractName: string,
  contractAddress: string,
  contractInstance: any,
...
export function ContractVarReceived(
  contractName: string,
  contractAddress: string,
  methodName: string,
  methodHash: string,
...
export function ContractVarErrorReceived(
  contractName: string,
  contractAddress: string,
  methodName: string,
  methodHash: string,
...
export function ContractVarForceRefresh(
  contractName: string,
  contractAddress: string,
  methodName: string,
  methodHash: string,
...
export function ContractCompleteRefresh(
  contract_name: string,
  contract_address: string,
