...
import {
  ...
  ContractSetDeployedAction,
  ContractVarErrorReceivedAction,
  ContractVarForceRefreshAction,
  ContractVarReceivedAction,
} from './contracts.actions';

const contractLoadingReducer: Reducer<ContractStoreState, ContractLoadingAction> = (
...
const contractLoadedReducer: Reducer<ContractStoreState, ContractLoadedAction> = (
  state: ContractStoreState,
...
const contractErrorReducer: Reducer<ContractStoreState, ContractErrorAction> = (
  state: ContractStoreState,
...
const contractVarReceivedReducer: Reducer<ContractStoreState, ContractVarReceivedAction> = (
  state: ContractStoreState,
...
const contractVarErrorReceivedReducer: Reducer<ContractStoreState, ContractVarErrorReceivedAction> = (
  state: ContractStoreState,
...
const contractVarForceRefreshReducer: Reducer<ContractStoreState, ContractVarForceRefreshAction> = (
  state: ContractStoreState,
...
const contractSetDeployedReducer: Reducer<ContractStoreState, ContractSetDeployedAction> = (
  state: ContractStoreState,
  action: ContractSetDeployedAction,
): ContractStoreState => {
  return {
    ...state,
...
export const contracts: Reducer<ContractStoreState, ContractActions> = (
  state: ContractStoreState = {},
