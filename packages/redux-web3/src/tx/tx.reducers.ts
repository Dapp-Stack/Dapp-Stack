...
import { TransactionState, TransactionStoreState } from '../stateInterface';
import { TxActions, TxBroadcastedAction, TxConfirmedAction, TxErrorAction, TxReceiptAction } from './tx.actions';

export const tx: Reducer<TransactionStoreState, TxActions> = (
  state: TransactionStoreState = {} as TransactionStoreState,
  action: TxActions,
