...
const AccountRemoveReducer: Reducer<AccountStoreState, AccountRemoveAction> = (
...
const AccountUpdateReducer: Reducer<AccountStoreState, AccountUpdateAction> = (
  state: AccountStoreState,
...
const AccountConfigReducer: Reducer<AccountStoreState, AccountConfigAction> = (
  state: AccountStoreState,
...
const AccountErrorReducer: Reducer<AccountStoreState, AccountErrorAction> = (
  state: AccountStoreState,
...
export const accounts: Reducer<AccountStoreState, AccountActions> = (
  state: AccountStoreState = {} as AccountStoreState,
