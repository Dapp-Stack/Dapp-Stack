...
const IPFSLoadedReducer: Reducer<IPFSStoreState, IPFSLoadedAction> = (
...
const IPFSErrorReducer: Reducer<IPFSStoreState, IPFSErrorAction> = (
  state: IPFSStoreState,
...
const IPFSConnectReducer: Reducer<IPFSStoreState, IPFSConnectAction> = (
  state: IPFSStoreState,
...
export const ipfs: Reducer<IPFSStoreState, IPFSActions> = (
  state: IPFSStoreState = {},
  action: IPFSActions,
): IPFSStoreState => {
  switch (action.type) {
