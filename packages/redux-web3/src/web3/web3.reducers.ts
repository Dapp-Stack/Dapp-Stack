...
export const web3: Reducer<Web3State, Web3Actions> = (
  state: Web3State = { status: 'LOADING' },
  action: Web3Actions,
): Web3LoadingState | Web3LoadedState | Web3LoadErrorState | Web3NetworkErrorState | Web3LockedState => {
  switch (action.type) {
    case 'LOAD_WEB3':
      return {
        status: 'LOADING',
