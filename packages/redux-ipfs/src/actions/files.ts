...
export const request = {
  ls: createAsyncAction('IPFS/LS/REQUEST', 'IPFS/LS/SUCCESS', 'IPFS/LS/FAILURE')<void, FILES_LIST, Error>(),
  ...
  rm: createAsyncAction('IPFS/RM/REQUEST', 'IPFS/RM/SUCCESS', 'IPFS/RM/FAILURE')<void, void, Error>(),

  cat: createAsyncAction('IPFS/CAT/REQUEST', 'IPFS/CAT/SUCCESS', 'IPFS/CAT/FAILURE')<void, void, Error>(),
};
