...
export const request = {
  ...
  network: createAsyncAction('ETH/NETWORK/REQUEST', 'ETH/NETWORK/SUCCESS', 'ETH/NETWORK/FAILURE')<
    ...
    Error
  >(),
  address: createAsyncAction('ETH/ADDRESS/REQUEST', 'ETH/ADDRESS/SUCCESS', 'ETH/ADDRESS/FAILURE')<
    void,
    string,
    Error
  >(),
  balance: createAsyncAction('ETH/BALANCE/REQUEST', 'ETH/BALANCE/SUCCESS', 'ETH/BALANCE/FAILURE')<
    void,
    ethers.ethers.utils.BigNumber,
    Error
  >(),
  blockNumber: createAsyncAction('ETH/BLOCK_NUMBER/REQUEST', 'ETH/BLOCK_NUMBER/SUCCESS', 'ETH/BLOCK_NUMBER/FAILURE')<
    void,
    number,
    Error
  >(),
  ...
  block: createAsyncAction('ETH/BLOCK/REQUEST', 'ETH/BLOCK/SUCCESS', 'ETH/BLOCK/FAILURE')<
    number,
    ethers.providers.Block,
    Error
  >(),
  transaction: createAsyncAction('ETH/TRANSACTION/REQUEST', 'ETH/TRANSACTION/SUCCESS', 'ETH/TRANSACTION/FAILURE')<
    string,
